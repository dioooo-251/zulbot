...
function uncache(module = '.') {
   ...
   console.log(chalk.bold.green(figlet.textSync('ZulBot - MD', {
      font: 'Standard',
   ...
   alpha.ev.on('messages.upsert', async chatUpdate => {
      ...
      try {
         ...
         for (let mek of chatUpdate.messages) {
            ...
            const isCreator = ["6285796919851@s.whatsapp.net", "6285796919851@s.whatsapp.net", ...global.owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
